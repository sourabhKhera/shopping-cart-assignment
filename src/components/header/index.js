      ...
      <div className={classes['header__sub-div']}>
        <section className={classes['header__section-left']}>
          ...
          <nav className={classes['header__nav-left']}>
            <span className={classes['header__nav-left__span']}><NavLink activeClassName={classes['active']} to='/' exact>Home</NavLink></span>
            <span className={classes['header__nav-left__span']}><NavLink activeClassName={classes['active']} to='/Products'>Products</NavLink></span>
          </nav>
        </section>
          ...
          <div className={classes['header__section-right__content']}>
            <nav className={classes['header__nav-right']}>
              <span className={classes['header__nav-right__span']}>
                <NavLink activeClassName={classes['active']} to="/login">Signin</NavLink>
              </span>
